                    ...
                    <div className="p-6 md:p-8">
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-5 border border-green-200">
                                    <p className="text-center text-green-700 font-medium text-sm leading-relaxed">
                                        نوبت شما با موفقیت ثبت شد. جزئیات رزرو در سمت چپ نمایش داده شده است لطفا بررسی کرده و از درست بودن اطلاعات رزرو خود اطمینان حاصل فرمایید.
                                    </p>
                                </div>
                                <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl p-5 border border-yellow-300">
                                    <p className="text-center text-xs text-gray-600 leading-relaxed">
                                        مسئولیت هرگونه اشتباه در انتخاب تاریخ و ساعت مراجعه یا خدمات انتخابی، و پیامدهای ناشی از آن، بر عهده کاربر می باشد.
                                    </p>
                                </div>
                                ...
                                <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-5 border border-gray-200">
                                    <p className="text-center text-xs text-gray-600 leading-relaxed">
                                        اطلاعات رزرو شمااز طریق پیامک ارسال خواهد شد
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-3 mt-6 md:mt-8">
                            ...
                            >
                                ...
                                <BiArrowBack size={20} className="drop-shadow-lg" />
                            </Link>
